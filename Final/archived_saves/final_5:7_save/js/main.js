...
//WORK PAGE TABS
    ...
    // TAB 5
      ...
      function show_intro1(){
        ...
        // // POP TAB OUT
        // // assign all tab_li variables
        // var tab1_li = document.getElementById('tab1_li');
        // var tab2_li = document.getElementById('tab1_li');
        // var tab3_li = document.getElementById('tab1_li');
        // var tab4_li = document.getElementById('tab1_li');
        // var tab5_li = document.getElementById('tab1_li');

        // // make all other tabs 100% width (reset)
        // gsap.to(tab2_li, 0.5, {width: "100%"});
        // gsap.to(tab3_li, 0.5, {width: "100%"});
        // gsap.to(tab4_li, 0.5, {width: "100%"});
        // gsap.to(tab5_li, 0.5, {width: "100%"});

        // //make the corresponding tab wider (pop out)
        // gsap.to(tab1_li, 0.5, {width: "125%"});
      }
